...
public class EntityUtils {
     ...
     * 1. Recursively clone the given entity and all of reachable entities from the given entity
     * 2. Link all parents of the original entity to the cloned entity
     */
    public static void deepClone(List<Entity> entities, List<Link> links, int id) {

        // HashMaps for fast entity & link retrieval
